                ...
                <div className="relative w-full mx-auto flex flex-col lg:flex-row justify-between items-center">
                  ...
                  <div className="w-10/12">
                    ...
                    <p className="mx-auto text-base font-landing mb-5">
                      ...
                      , a site for Token Launch Auctions. All proceeds will go
                      to the <span translate="no">Popcorn</span> Treasury, a
                      smart contract entirely controlled by{' '}
      ...
      <section className="">
        <div className="">
          <div className="">
            ...
            <div className="w-10/12 mx-auto my-12">
              ...
              <p className="text-base mx-auto ">
                ...
                distribution at launch, resulting in a fully customizable token
                distribution mechanic that gives teams and governance token
                holders control and flexibility for the long term.
              </p>
            </div>
            ...
            <div className="w-10/12 mx-auto my-12">
              ...
              <p className="text-base mx-auto ">
                ...
                follow the end of the Token Launch Auction in December. The only
                way to take advantage of the staking rewards and liquidity
                mining incentives is to have POP tokens. The POP tokenomic model
                specifies that the greatest amount of staking rewards emitted
                will be during the first several weeks of the liquidity mining
                incentives program, therefore the earliest users will have the
                greatest possible opportunity to earn more POP tokens.
              </p>
            </div>
            ...
            <div className="w-10/12 mx-auto my-12">
              ...
              <p className="text-base mx-auto ">
                ...
                as it is difficult to determine the last price precisely. Thank
                you to the Perpetual Protocol team for putting together this
                model!
              </p>
            </div>
          ...
          <div className="w-10/12 mx-auto my-14">
            <p className="font-bold text-xl mb-5 mx-auto ">
              What do tokens do I need to have in order to participate in the
            ...
            <p className="text-base mx-auto font-bold mt-3 mb-1">Ethereum:</p>
            <ul className="list-disc list-inside">
              <li className="text-base mx-auto font-bold">Metamask Wallet</li>
              <li className="text-base mx-auto">
                <span className="font-bold">ETH</span> - this is used to pay for
                transaction fees
              </li>
              <li className="text-base mx-auto">
                <span className="font-bold">USDC</span> - this is used to pay
                for the token
              </li>
            </ul>
            <p className="text-base mx-auto font-light mt-3">
              If you are participating on Ethereum, you will need to have a
              wallet with ETH (to pay for gas fees) and USDC to purchase POP
              token.{' '}
              <a
                className="text-base text-blue-600 hover:text-blue-700 underline cursor-pointer"
            ...
            <p className="text-base mx-auto font-bold mt-3 mb-1">Polygon:</p>
            <ul className="list-disc list-inside">
              <li className="text-base mx-auto font-bold">Metamask Wallet</li>
              <li className="text-base mx-auto">
                <span className="font-bold">MATIC</span> - this is used to pay
            ...
            <p className="text-base mx-auto font-light mt-3">
              ...
              wallet with MATIC (to pay for gas fees) and USDC to purchase POP
              token.{' '}
              <a
                className="text-base text-blue-600 hover:text-blue-700 underline cursor-pointer"
                href="https://medium.com/popcorndao/preparing-for-popcorns-token-launch-on-copper-a-beginner-s-guide-ed1921760ae2'"
