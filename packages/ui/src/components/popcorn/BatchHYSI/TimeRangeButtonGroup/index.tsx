...
export const TimeRangeButtonGroup: React.FC = ({}): JSX.Element => {
  ...
  return (
    <div className="flex flex-row py-2 my-2 px-2 rounded-full shadow-sm text-white bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 mb-8">
      {ranges.map((range) => {
        return (
          <button
            type="button"
