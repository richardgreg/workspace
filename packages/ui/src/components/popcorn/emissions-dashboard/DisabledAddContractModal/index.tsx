...
export interface DisabledContractModalProps {
  open: boolean;
  setOpen: (state: boolean) => void;
}

export const DisabledAddContractModal: React.FC<DisabledContractModalProps> = ({
  open,
  setOpen,
}) => {
                  ...
                  <div className="mt-3 text-center sm:text-left mx-auto">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-700 pb-1">
                        Coming soon: Add your own Ethereum contracts to the
